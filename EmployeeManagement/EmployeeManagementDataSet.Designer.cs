...
namespace EmployeeManagement {
    ...
    public partial class EmployeeManagementDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(string Name, string Position, double Salary) {
...
namespace EmployeeManagement.EmployeeManagementDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employees] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([" +
                "Name] = @Original_Name) AND ([Position] = @Original_Position) AND ([Salary] = @O" +
                "riginal_Salary))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([Name], [Position], [Salary]) VALUES (@Name, @Posi" +
                "tion, @Salary);\r\nSELECT EmployeeID, Name, Position, Salary FROM Employees WHERE " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [Name] = @Name, [Position] = @Position, [Salary] = @Salary WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Name] = @Original_Name) AND ([Position] = @Original_Position) AND ([Salary] = @Original_Salary));
SELECT EmployeeID, Name, Position, Salary FROM Employees WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EmployeeManagement.Properties.Settings.Default.EmployeeManagementConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, Name, Position, Salary FROM dbo.Employees";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT EmployeeID, Name, Position, Salary FROM dbo.Employees";
        ...
        public virtual int FillBy(EmployeeManagementDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_Name, string Original_Position, double Original_Salary) {
        ...
        public virtual int Insert(string Name, string Position, double Salary) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Position, double Salary, int Original_EmployeeID, string Original_Name, string Original_Position, double Original_Salary, int EmployeeID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Position, double Salary, int Original_EmployeeID, string Original_Name, string Original_Position, double Original_Salary) {
            return this.Update(Name, Position, Salary, Original_EmployeeID, Original_Name, Original_Position, Original_Salary, Original_EmployeeID);
        }
    }
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([UserID] = @Original_UserID) AND ([Username] = " +
                "@Original_Username) AND ([Password] = @Original_Password) AND ((@IsNull_Role = 1" +
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Username] = @Username, [Password] = @Password, [Role] = @Role WHERE (([UserID] = @Original_UserID) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ((@IsNull_Role = 1 AND [Role] IS NULL) OR ([Role] = @Original_Role)));
